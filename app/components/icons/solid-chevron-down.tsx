...
export const SolidChevronDownIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 0 32 33" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
