...
export const CloseIcon = (props: SVGProps<SVGSVGElement> & MotionProps) => (
  <Motion.svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 384 512" {...(props as object)}>
    <path
      fill="currentColor"
